...
<html lang="en">
  ...
  <title>EcoShare &middot; About</title>
  ...
  <div class="container">
      ...
      <div class="navbar-inner">
            <div class="container">
              <ul class="nav">
                ...
                <li class="active"><a href="/EcoShare/About.jsp">About</a></li>
              </ul>
            </div>
      </div>
        </div><!-- /.navbar -->
      ...
      <div class="jumbotron">
        <form name="form2" method="post" action="">
          ...
          <p>&quot;Connect with other students to share a ride to the University or to your hometown to reduce the </p>
          <p>impact to the environment and save money&quot;          </p>
          <p>EcoShare is a user controlled space where users connect to share rides, that way the user can </p>
          <p>get to the destination whilst reducing the carbon footprint and saving money.          </p>
          <p>The aim of EcoShare is to provide a totally unregulated and open space where users can </p>
          <p>facilitate “carpooling”. This is not a taxi service unlike other systems in place. Any user can set </p>
          <p>up a ride and share to other users. All responsibility falls in the user, as with many other things. </p>
          <p>By allowing these access to all users, EcoShare hopes to become the go-to solution for </p>
          <p>students. Many students, and regular users, don’t own a vehicle and rely on others to get to </p>
          <p>their locations. EcoShare hopes to open up a larger number of options for those who need it on </p>
          <p>a daily basis, or those who need it from time to time, every user is welcome.</p>
          <span id="sprytextfield3">
          <label for="text2"></label>
          <span class="textfieldRequiredMsg">A valu</span></span>
      </form>
      </div>
